...
public class MineCellsItemGroups {
  ...
  public static final ItemGroup MINECELLS_BLOCKS_AND_ITEMS = FabricItemGroupBuilder.create(MineCells.createId("blocks_and_items"))
    ...
    .appendItems(stacks -> stacks.addAll(List.of(
      ...
      MineCellsBlocks.PUTRID_BOARD_BLOCK.asItem().getDefaultStack(),
      MineCellsBlocks.PUTRID_BOARD_STAIRS.asItem().getDefaultStack(),
      MineCellsBlocks.PUTRID_BOARD_SLAB.asItem().getDefaultStack(),
      MineCellsBlocks.PUTRID_BOARDS.asItem().getDefaultStack(),
      ...
      MineCellsBlocks.PROMENADE_TORCH.asItem().getDefaultStack(),
