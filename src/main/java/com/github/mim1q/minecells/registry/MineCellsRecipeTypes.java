...
public class MineCellsRecipeTypes {
  public static final RecipeType<CellForgeRecipe> CELL_FORGE_RECIPE_TYPE = RecipeType.register("cell_forge_recipe");

  public static void init() {
    register("cell_forge_recipe", CellForgeRecipeSerializer.INSTANCE);
  }
