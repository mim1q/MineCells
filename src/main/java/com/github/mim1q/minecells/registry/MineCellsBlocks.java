...
public class MineCellsBlocks {
  ...
  public static final SkeletonDecorationBlock HANGED_SKELETON = registerBlock(new SkeletonDecorationBlock(AbstractBlock.Settings.copy(Blocks.DIRT).noCollision().strength(0.5F).sounds(BlockSoundGroup.BONE)), "hanged_skeleton");
  public static final SkeletonDecorationBlock SKELETON = registerBlockWithItem(new SkeletonDecorationBlock(AbstractBlock.Settings.copy(HANGED_SKELETON).dropsLike(HANGED_SKELETON), HANGED_SKELETON), "skeleton");
  public static final SkeletonDecorationBlock HANGED_CORPSE = registerBlock(new SkeletonDecorationBlock(AbstractBlock.Settings.copy(Blocks.DIRT).noCollision().strength(0.5F).sounds(BlockSoundGroup.MUD).ticksRandomly()), "hanged_corpse");
  public static final SkeletonDecorationBlock CORPSE = registerBlockWithItem(new SkeletonDecorationBlock(AbstractBlock.Settings.copy(HANGED_CORPSE).dropsLike(HANGED_CORPSE).ticksRandomly(), HANGED_CORPSE), "corpse");
  public static final SkeletonDecorationBlock HANGED_ROTTING_CORPSE = registerBlock(new SkeletonDecorationBlock(AbstractBlock.Settings.copy(HANGED_CORPSE).ticksRandomly()), "hanged_rotting_corpse");
  public static final SkeletonDecorationBlock ROTTING_CORPSE = registerBlockWithItem(new SkeletonDecorationBlock(AbstractBlock.Settings.copy(HANGED_CORPSE).dropsLike(HANGED_ROTTING_CORPSE).ticksRandomly(), HANGED_ROTTING_CORPSE), "rotting_corpse");
