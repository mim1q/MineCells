...
public class WoodSet extends FeatureSet {
  ...
  public WoodSet(Identifier identifier, FabricItemSettings defaultItemSettings, FabricBlockSettings defaultBlockSettings) {
    super(identifier, defaultItemSettings, defaultBlockSettings);
    StrippableBlockRegistry.register(log, strippedLog);
    StrippableBlockRegistry.register(wood, strippedWood);
  }

  public final List<ItemStack> stacks = Stream.of(
